...
<div class="page-body">
	<div class="container-xl">
		<div class="row row-deck row-cards">
			<div class="col-md-12">
				<form class="card" method='POST' action='{{ route('board.teachers.update' , $teacher ) }}' >
					@csrf
					@method('PATCH')
					<div class="card-header bg-primary">
						<h3 class="card-title text-white"> تعديل بينات الدكتور </h3>
					</div>
						...
						<div class="row row-cards">
							...
							<div class="col-md-6">
								<div class="mb-3">
									...
									<div>
										<input type="text" class="form-control @error('mobile') is-invalid @enderror " name='mobile' value="{{ $teacher->mobile }}" >
										@error('mobile')
										<small class="form-hint text-danger"> {{ $message }} </small>
										@enderror
									</div>
									...
									<div class="col-md-6">
										<div>
											<label class="form-check">
												<input class="form-check-input" name='is_active' type="checkbox" {{ $teacher->is_blocked != true ? 'checked'  : '' }} >
							...
							<div class="col-md-12">
								<div class="mb-3">
									...
									<div>
										<input type="text" class="form-control @error('notes') is-invalid @enderror " name='notes' value='{{ $teacher->notes }}'  >
										@error('notes')
										<small class="form-hint text-danger"> {{ $message }} </small>
										@enderror
									</div>
									...
									<div class="col-md-3">
										<div class="mb-3">
											...
											<div>
												...
												<label class="form-check">
													<input class="form-check-input permissions" name='permissions[]' value='{{ $item->name }}' type="checkbox" @checked(in_array($item->name , $teacher_permissions))  >
