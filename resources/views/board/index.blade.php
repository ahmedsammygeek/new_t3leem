          ...
          <div class="card-body">
            <div class="row align-items-center">
              ...
              <div class="col">
                ...
                <div class="text-muted">
                  مستحقات يجب تسديدها هذا الاسبوع 
                </div>
              </div>
            </div>
          </div>
