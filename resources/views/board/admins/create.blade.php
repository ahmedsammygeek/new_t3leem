...
<div class="page-body">
	<div class="container-xl">
		<div class="row row-deck row-cards">
			<div class="col-md-12">
				<form class="card" method='POST' action='{{ route('board.admins.store') }}' enctype="multipart/form-data" >
					@csrf
							...
							<div class="col-md-6">
								<div class="mb-3 row">
									...
									<div class="col-md-6">
										<div>
											<label class="form-check">
												<input class="form-check-input is_super_admin" value='true' name='is_super_admin' type="checkbox" >
					...
					<div class="card-footer text-end">
						<div class='d-flex' >
							<a href="{{ route('board.admins.index') }}" class="btn btn-link"> تراجع </a>
