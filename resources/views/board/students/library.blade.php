      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class=" list-group list-group-flush">
            ...
            <a href="{{ route('board.users.library') }}" class="list-group-item list-group-item-action active" aria-current="true">
...
<div class="col-10">
  <div class="card">
    <div class="card-header bg-primary">
      <h3 class="card-title text-white"> الملفات  الخاصه بالطالب </h3>
    </div>
      ...
      <table class="table card-table table-vcenter">
        <thead>
          <tr>
            ...
            <th> عنوان الدرس </th>
            <th> اسم الملف </th>
            <th> عدد مرات التحميل المسموح بها </th>
            <th> عدد مرات التحميل المستخدمه  </th>
            <th> عدد مرات التحميل المتبقيه  </th>
