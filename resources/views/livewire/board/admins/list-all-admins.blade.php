                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                {{-- @can('admins.show') --}}
                                <a  href="{{ route('board.admins.show'  , $admin ) }}"  class="btn  btn-primary  btn-icon ">
                                    <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-eye"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10 12a2 2 0 1 0 4 0a2 2 0 0 0 -4 0" /><path d="M21 12c-2.4 4 -5.4 6 -9 6c-3.6 0 -6.6 -2 -9 -6c2.4 -4 5.4 -6 9 -6c3.6 0 6.6 2 9 6" /></svg>
                                </a>
                                {{-- @endcan --}}
                                {{-- @can('admins.edit') --}}
                                <a href="{{ route('board.admins.edit'  , $admin ) }}"  class="btn btn-warning  btn-icon">
                                    <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-edit"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M7 7h-1a2 2 0 0 0 -2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2 -2v-1" /><path d="M20.385 6.585a2.1 2.1 0 0 0 -2.97 -2.97l-8.415 8.385v3h3l8.385 -8.415z" /><path d="M16 5l3 3" /></svg>
                                </a>                           
                                {{-- @endcan --}}

                                <a  wire:click="$dispatchTo('board.admins.change-admin-password', 'show-password-change-modal' , { admin_id : {{ $admin->id }} } )" class="btn btn-info  btn-icon">
                                ...
                                {{-- @can('admins.delete') --}}
                                <a data-item_id='{{ $admin->id }}' class="btn btn-danger btn-icon delete_item">
