                ...
                <table class="table text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('board.universities.show' , $university ) }}" class="d-block fw-semibold">{{ $university->name }}</a>
                                <span class="fs-sm text-muted">{{ $university->created_at->toFormattedDateString() }}</span>
                            </td>
                            <td>
                            ...
                            <td class="text-center">
                                {{-- @can('admins.show') --}}
                                <a  href="{{ route('board.universities.show'  , $university ) }}"  class="btn  btn-primary  btn-icon ">
                                    <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-eye"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10 12a2 2 0 1 0 4 0a2 2 0 0 0 -4 0" /><path d="M21 12c-2.4 4 -5.4 6 -9 6c-3.6 0 -6.6 -2 -9 -6c2.4 -4 5.4 -6 9 -6c3.6 0 6.6 2 9 6" /></svg>
                                </a>
                                {{-- @endcan --}}
                                {{-- @can('admins.edit') --}}
                                <a href="{{ route('board.universities.edit'  , $university ) }}"  class="btn btn-warning  btn-icon">
                                ...
                                {{-- @can('admins.delete') --}}
                                <a data-item_id='{{ $university->id }}' class="btn btn-danger btn-icon delete_item">
...
<script>
    $(function() {
        ...
        $(document).on('click', 'a.delete_item', function(event) {
            ...
            Swal.fire({
                title: 'تاكيد الحذف',
                text: "هل انت متاكد من رغبتك فى حذف الجامعه ؟",
                icon: 'warning',
